...
function that reads them are defined together. `trainmate_cli` imports `add_bot_parser`
from here and names nothing else in this package.
"""
from trainmate.cli.bot.capture import CAPTURE_INTENTS, run_bot_capture
from trainmate.cli.bot.route import run_bot_route
from trainmate.cli.bot.views import (
    run_bot_changes, run_bot_constraints, run_bot_goals, run_bot_mesocycle,
    run_bot_morning,
)
from trainmate.cli.queue import run_bot_queue
