...
`trainmate.chat.routing.ROUTER_INTENTS` and prints it as one JSON line; the bot maps
...
from trainmate.chat.routing import ROUTER_INTENTS
from trainmate.cli.bot.extraction import nominate_rows
