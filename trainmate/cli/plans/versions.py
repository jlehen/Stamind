...
the lineage `trainmate/plan_versions.py` builds (DESIGN_plan_rollback.md §6)."""
import argparse
...
from trainmate.cli.common import print_hanging, print_plan_cascade, print_segments, report_unhonored
