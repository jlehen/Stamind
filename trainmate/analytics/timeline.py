...
fetch that feeds it is `trainmate/timeline_rows.py`, which is outside
`trainmate/analytics/` because it reads the database.
"""
...
from trainmate.analytics.progression import (
    daily_loads, fitness_series, weekly_aggregates,
)
from trainmate.analytics.runway import plan_dates, plan_end, plan_gap
