...
`ChatBot` is what `trainmate_bot.py` builds and runs. It reads the `telegram:` section of
...
from trainmate.chat.callbacks import CallbacksMixin
from trainmate.chat.keyboards import (
    MENU_COMMANDS, SIMPLE_MENU_COMMANDS, simple_keyboard_rows,
)
from trainmate.chat.messages import MessagesMixin
from trainmate.chat.replies import RepliesMixin
from trainmate.chat.runner import RunnerMixin, Session
from trainmate.chat.scheduler import SchedulerMixin
