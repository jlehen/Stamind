...
from stamind.analytics.pmc import pmc_ramp
from stamind.signals import excluded_channels
...
def norm_signal_value(value: Optional[float]):
    ...
    (presence-only / unparseable) stays None (§3.1). Stamind never interprets the
