...
from stamind.types import Workout, CompletedActivity
...
def _load_science_guidelines(app_science_dir: str, science_dir: str) -> str:
    ...
    sections = [
        science_section(
            app_science_dir,
            "STAMIND SPORTS SCIENCE GUIDELINES",
            "Stamind's own reference material, shipped with the app. It defines how to\n"
