...
from stamind.coach.service.athlete_context import AthleteContextMixin
from stamind.coach.service.staleness import StalenessMixin
from stamind.coach.service.planning import PlanningMixin
from stamind.coach.service.goals_constraints import GoalsConstraintsMixin
from stamind.coach.service.generate import WorkoutGenMixin
from stamind.coach.service.standing import StandingMixin
from stamind.coach.service.guards import GuardsMixin
from stamind.coach.service.adapt import AdaptMixin
...
class CoachService(HistoryContextMixin, MesocycleContextMixin, AthleteContextMixin,
    ...
    def _prompt(self):
        ...
        It used to reach up with `import stamind_cli as cli` mid-method, which meant
