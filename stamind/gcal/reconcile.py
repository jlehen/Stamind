...
from stamind.analytics.adherence import classify_adherence
from stamind.analytics.compare import adherence_window, format_actual
from stamind.workout_state import adherence_signature, calendar_status
...
from stamind.output import Progress, fail, warn
...
def _framing(total: int) -> Iterator[Progress]:
    ...
    from stamind.gcal.client import quiet_events
