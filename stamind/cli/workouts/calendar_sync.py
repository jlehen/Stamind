...
from stamind.workout_state import calendar_status
from stamind.text import cmd, cyan, dim, green, red
from stamind.output import notice, step
from stamind.clock import fmt_date, fmt_span, today_str as _today_str
from stamind.cli.windows import resolve_window
from stamind.gcal.event import event_day
...
def warn_stale_before(start_date: str) -> None:
    ...
    re-push it. Freshness is derived, not stored (see stamind.workout_state), so
