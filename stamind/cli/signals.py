...
Stamind writes the same tagged `source=<signal_tag>` all-day events the
...
from stamind.text import bold, cyan, dim, green, magenta, red
from stamind.output import notice
from stamind.clock import date_range, fmt_date, fmt_span, today_str as _today_str
...
def add_signal_parser(subparsers):
    ...
    signal_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "'list' and 'list-metrics' inspect what's recorded. Stamind stays "
