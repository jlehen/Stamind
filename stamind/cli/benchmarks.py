...
from stamind.text import bold, cmd, cyan, dim, format_labeled_paragraph, gray, green, red
from stamind.output import aside, notice
from stamind.clock import fmt_date, today_str as _today_str
from stamind.cli.selectors import add_single_date_arg
from stamind.sports import canonical_sport
from stamind import benchmarks
from stamind.benchmarks import (
...
def add_benchmark_parser(subparsers):
    ...
    b_rec = b_subparsers.add_parser(
        ...
        description=(
            ...
            "detection (they are two independent settings). Stamind treats the values "
